...
//					co.pattern.manager.showUpdatePanel();
//					var id = this.cells[0].innerText;
//					var pattern = this.cells[1].innerText;
//					var tag = this.cells[2].innerText;
//					var priority = this.cells[3].innerText;
//					
//					art.dialog({
//						id : 'updatePattern',
//					    title: 'Update',
//					    width: 424,
//					    height: 184,
//					    content: "<div style='width:420px;height:180px'>"+
//					    			"<div><div style='width:90px;float: left;margin-top:10px;'>Pattern:</div><input id='updatePattern' value='"+pattern+"' style='float:left;margin-top:10px;width:270px' class='input-medium search-query' type='text' /></div>" +
//					    			"<div style='clear:both'><div style='width:90px;float: left;margin-top:10px'>Tag:</div><input id='updateTag' value='"+tag+"' style='float:left;margin-top:10px;width:270px' class='input-medium search-query' type='text' /></div>" +
//					    			"<div style='clear:both'><div style='width:90px;float: left;margin-top:10px'>Priority:</div><input id='updatePriority'  value='"+priority+"' style='float:left;margin-top:10px;width:270px' class='input-medium search-query' type='text' /></div>"+
//					    			"<div style='clear:both'><div style='width:193px;float: right;margin-top:10px'><input id='updateBtn' style='margin-top:10px;float:left;margin-right: 10px' value='Update'  type='button' "+
//					    			" onclick='co.pattern.manager.updatePost(\""+id+"\",$(\"#updatePattern\").val(),$(\"#updateTag\").val(),$(\"#updatePriority\").val());' /></input>"+
//					    			"<input id='cancelBtn' style='margin-top:10px;float:left' value='Cancel'  type='button' onclick='art.dialog({id:\"updatePattern\"}).close();' /></input></div></div>"+
//					    			"</div>"
//					});
					if (p.onDoubleClick) {
