...
<%
	...
	if(verify_result){//验证成功
		...
		//该页面可做页面美工编辑
		out.println("支付成功<br /><script type=\"text/javascript\"> window.location.href ='navUserInfor.html';</script>");
		//out.println("支付成功<br /><script type=\"text/javascript\"> window.location.href ='about:blank';window.opener = null;window.open('', '_self');window.close();</script>");
